...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Linkup — Find your campus crew" },
      { property: "og:description", content: "Match with students on campus who share your interests, and discover workshops, events, and meetups together." },
      { name: "twitter:description", content: "Match with students on campus who share your interests, and discover workshops, events, and meetups together." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/0af8cc7b-9b9c-4591-8938-ed62081ccbf4/id-preview-ebe74383--95a93769-e2ed-4de5-9605-d261778985dc.lovable.app-1779600654295.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/0af8cc7b-9b9c-4591-8938-ed62081ccbf4/id-preview-ebe74383--95a93769-e2ed-4de5-9605-d261778985dc.lovable.app-1779600654295.png" },
